...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://batbilguun-buynzaya-wedding.netlify.app/images/Gemini_Generated_Image_svfda9svfda9svfd.jpg?v=20",
        secureUrl: "https://batbilguun-buynzaya-wedding.netlify.app/images/Gemini_Generated_Image_svfda9svfda9svfd.jpg?v=20",
        width: 1200,
        height: 630,
        type: "image/jpeg",
  ...
  twitter: {
    ...
    title: "Ц.Батбилгүүн & Н.Буянзаяа | Хуримын урилга",
    description: "2026 оны 10-р сарын 04-ний өдөр Ховд аймагт болох бидний хуримын ёслолд урьж байна.",
    images: ["https://batbilguun-buynzaya-wedding.netlify.app/images/Gemini_Generated_Image_svfda9svfda9svfd.jpg?v=20"],
  },
